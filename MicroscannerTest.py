...
class MicroscannerTest(QMainWindow):
    ...
    # For example, take a snapshot of the current camera feed and save it
    # You can use OpenCV to capture and save the image
    # For instance:
    # image = self.cam.stream()  # Assuming self.cam is your camera instance
